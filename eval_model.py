...
def init_model(args):
    ...
    if args.load == 0:
        ...
        # ckp = f'./{args.out_dir}/{modes[args.model_mode]}_{args.hidden_size}{moe_path}_0.pth'
    ...
    print(f'MiniMind模型参数量: {sum(p.numel() for p in model.parameters() if not p.stop_gradient) / 1e6:.2f}M(illion)')
...
def main():
    ...
    parser.add_argument('--checkpoint', type=str, default="/home/hyg/minimind-paddle/out/pretrain_512_swanlab.pth")
    parser.add_argument('--lora_name', default='None', type=str)
    parser.add_argument('--out_dir', default='out', type=str)
    parser.add_argument('--temperature', default=0.85, type=float)
    parser.add_argument('--top_p', default=0.85, type=float)
    parser.add_argument('--device', default=auto_detect_device(), type=str)
    ...
    parser.add_argument('--load', default=0, type=int, help="0: 原生paddle权重，1: paddlenlp加载")
